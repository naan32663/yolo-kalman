# -*- coding: utf-8 -*-
"""
Created on Fri Oct 23 21:01:38 2020
...
def detect(save_img=False):
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if det is not None and len(det):
                ...
                for *xyxy, conf, cls in reversed(det):                        
                    file_name.append(str(Path(path).stem)) 
    ...
    dataframe = pd.DataFrame({'File_name':file_name,'Xmin':xmin, 'Ymin':ymin, 'Xmax':xmax, 'Ymax': ymax})
